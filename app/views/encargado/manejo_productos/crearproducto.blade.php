        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   ...
                   {{Form::open(array('url'=>'ingreso/crear','method'=>'post','class'=>'form-horizontal','autocomplete'=>'off', 'id'=>'frmingresoconfirmar','target'=>'_blank'))}}
                               
                                <div id="divapellidos" class="form-group">
                                  <label for="inputEmail3" class="col-sm-4 control-label">Al almacen de:</label>
                                    <div class="col-sm-8">
                                      <input list="ubicacion" id="al_almacen" class="form-control" placeholder="al almacen de" name="al_almacen">
                                    </div>
                                </div>                     
                                <div id="divtelefono" class="form-group">
                                ...
                                <div id="divnick"class="form-group">
                                  <label for="inputEmail3"  class="col-sm-4 control-label">Pedido de compra: </label>
                                    <div class="col-sm-8">
                                      @if($correcto=="true")
                                        <select id="numero_pedido" name="numero_pedido" class="form-control">                                                       
                                              @foreach($pedidosporingresar as $p)
                                                   <option name="numero_pedido">
                                                       {{$p->numero}}
                                                   </option>
                                              @endforeach
                                          </select>
                                      @endif
                                         ...
                                         @if($correcto=="false")
                                                 <input id="numero_pedido" type="text" name="numero_pedido" value="No hay pedido compras" class="form-control" Disabled>
                                         @endif
                                ...
                                <div class="table-responsive">
                                    <div class="btn-group">
                                        ...
                                        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modalConfirmar">
                                           <i class="fa fa-check fa-fw"></i> Confirmar Ingreso (NOTA DE INGRESO)
